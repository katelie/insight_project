...
for recipenumber, url in enumerate(sub_urllist): 
    soup = OpenPage(url)
...
comments, commentnumber = GetComments_SK(soup)
recipe, title = GetRecipe_SK(soup, i)
